...
from user_calendar_data import get_empty_time_ranges_and_durations, get_dt_fifteen_min_rounded, get_user_events_time_range, get_user_time_zone, get_user_calendar_id_list, separate_periods_time_ranges
...
if user is None:
  ...
  print('get_empty_time_ranges_and_durations')
